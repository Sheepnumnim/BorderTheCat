...
void gotoHome()
{
    ...
    // background
    Texture bgt;
    bgt.loadFromFile("pics/bg.png");
    Sprite bgs(bgt);
    bgs.setPosition(0,150);
...
int gameLoop(int levelSelect)
{
    ...
    hexagon.setOutlineColor(Color(244, 195, 95, 125));
...
//                cout << hex[i].get_x() << "," << hex[i].get_y() << endl;
    ...
    for(int i=0; i<40; i++)
    {
        ...
        hex[goal[i]].setOutlineColor(Color(1,0,0,0));
        hex[goal[i]].setFillColor(Color(1,0,0,0));
